      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <p className="text-[11.5px] mt-1.5" style={{ color: "var(--text-tertiary)" }}>
            The concept or pattern you studied
          </p>
          {showSuggestions && topic && filtered.length > 0 && (
            <div
              className="absolute z-10 top-full left-0 right-0 mt-1 rounded-lg overflow-hidden"
              style={{
                background: "var(--card-elevated)",
                border: "1px solid var(--border-strong)",
        ...
        <div className="mt-4">
          ...
          />
          <p className="text-[11.5px] mt-1.5" style={{ color: "var(--text-tertiary)" }}>
            Where you learned it — book, video, article
          </p>
        </div>
        ...
        <button
          ...
          style={{
            fontFamily: "var(--font-body)",
            background: canSubmit ? "var(--accent)" : "var(--card-elevated)",
            color: canSubmit ? "var(--bg)" : "var(--text-tertiary)",
